...
This chapter covers a variety of topics about using R for linear regression. We demonstrate how R can be used for linear regression analysis. This chapter is based on the `STATA` web tutorial from UCLA. ^[Chen, X., Ender, P., Mitchell, M. and Wells, C. (2003). Regression with Stata, from https://stats.idre.ucla.edu/stat/stata/webbooks/reg/default.htm]
