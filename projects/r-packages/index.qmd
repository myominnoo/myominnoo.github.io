...
## wpgdata {#sec-rpkg-wpgdata}

<img src="./wpgdata-logo.png" align="right" height="138"/>
...
using the OData V4 API. It supports filtering rows with R expressions
or raw OData strings, selecting columns, sorting, and automatic
pagination with a progress bar — making it easy to access Winnipeg's
open data directly from R without manual API calls.

<a href="https://myominnoo.github.io/wpgdata/" target="_blank">Documentation</a>
\| <a href="https://github.com/myominnoo/wpgdata/" target="_blank">Source
Code</a> \|
<a href="https://cran.r-project.org/package=wpgdata" target="_blank">CRAN</a><br>


## mStats {#sec-rpkg-mStats}

<img src="./mStats-logo.png" align="right" height="120"/>
...
<img src="./shinyAuthX-logo.png" align="right" height="138"/>
